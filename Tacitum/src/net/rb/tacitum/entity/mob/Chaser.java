...
public class Chaser extends Mob {
	private AnimatedSprite chaser_down  = new AnimatedSprite(SpriteSheet.dummy_down, 32, 32, 3);
	private AnimatedSprite chaser_up    = new AnimatedSprite(SpriteSheet.dummy_up, 32, 32, 3);
	private AnimatedSprite chaser_left  = new AnimatedSprite(SpriteSheet.dummy_left, 32, 32, 3);
	private AnimatedSprite chaser_right = new AnimatedSprite(SpriteSheet.dummy_right, 32, 32, 3);
